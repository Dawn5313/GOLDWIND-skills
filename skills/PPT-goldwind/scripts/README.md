...
| Image tools | `image_gen.py`, `api_image_generate.py`, `analyze_images.py`, `gemini_watermark_remover.py` | [docs/image.md](./docs/image.md) |
...
```bash
python3 scripts/image_gen.py "A modern futuristic workspace" --backend image2 --aspect_ratio 16:9 --image_size 2K
