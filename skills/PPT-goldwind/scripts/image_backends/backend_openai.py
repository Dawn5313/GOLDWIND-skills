...
# Aspect ratio -> GPT Image 2 size mapping.
# Covers common PPT/social media ratios and keeps values within the API's
# multiple-of-16, max-edge, and max-pixel constraints.
...
def _generate_image(api_key: str, prompt: str, negative_prompt: str = None,
    ...
    try:
        ...
        resp = client.images.generate(**request_kwargs)
    finally:
        heartbeat_stop.set()
