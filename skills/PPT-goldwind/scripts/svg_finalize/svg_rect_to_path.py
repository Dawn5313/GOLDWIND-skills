#!/usr/bin/env python3
"""
PPT Goldwind - SVG Rounded Rectangle to Path Tool
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description='PPT Goldwind - SVG Rounded Rectangle to Path Tool',
...
'''
    ...
    if not quiet:
        print("PPT Goldwind - SVG Rounded Rectangle to Path Tool")
        print("=" * 50)
